...
<div class="main clearfix ofHidden block yh">
  <input type="hidden" name="id" value="${bean.id }"/>
    ...
    <div class="main_right fright">
    	<div class="title clearfix"><font class="yh f16">Vitals Details</font><span class="fright f12">Home > <a href="#">Vitals Details</a></span></div>
    	 <input type="hidden" name="id" value="${bean.id }"/>
        <div class="newsnr">
        
      <h1 class="bt">Vitals Details</h1>
       <p style="text-indent: 2em">&nbsp;&nbsp;&nbsp;&nbsp;ID: <input style="width:30%;" type="text" readonly  value="${bean.bianhao }"></p>
       <p style="text-indent: 2em">&nbsp;&nbsp;&nbsp;&nbsp;Time: <input style="width:30%;" type="text" readonly  value="${bean.times }"></p>
        <p style="text-indent: 2em">&nbsp;&nbsp;&nbsp;&nbsp;Status: <input style="width:30%;" type="text" readonly  value="${bean.stauts }"></p>
         <p style="text-indent: 2em">&nbsp;&nbsp;&nbsp;&nbsp;Account: <input style="width:30%;" type="text" readonly  value="${bean.user.username }"></p>
